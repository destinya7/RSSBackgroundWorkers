...
namespace RSSFetcherService.Tests.Core
{
    public class FetcherCoreTests
    {
        ...
        public async void FetchChannel_Inserts_Channel()
        {
            ...
            httpRssClientMoq
                .Setup(client => client.GetRSSXmlString("http://www.channel4.com"))
            ...
            channelRepoMoq
                .Setup(repo => repo.Get(channels[0].Id))
                .ReturnsAsync(channels[0]);
            channelRepoMoq
                .Setup(repo => repo.GetByUrl(channels[0].Link))
                .Returns(Task.FromResult<Channel>(null));
            channelRepoMoq
                .Setup(repo => repo.Add(channel))
        ...
        public async void FetchChannel_Updates_Channel()
        {
            ...
            channelRepoMoq
                .Setup(repo => repo.GetByUrl("http://www.channel1.com"))
